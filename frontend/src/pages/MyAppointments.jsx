                ...
                {appointments.map((item, index) => (
                    ...
                    >
                        ...
                        <div className='flex flex-col gap-2 justify-end'>
                            ...
                            {item.cancelled && item.cancelledBy === 'user' && !item.isCompleted && (
                                <button className='sm:min-w-48 py-2 border border-red-500 rounded text-red-500'>
                                    Appointment Cancelled
                                </button>
                            )}
                            {item.cancelled && (item.cancelledBy === 'doctor' || item.cancelledBy === 'admin') && !item.isCompleted && (
                                <button className='sm:min-w-48 py-2 border border-orange-500 rounded text-orange-500 px-2'>
                                   Appointment Cancelled. Please choose another day.
                                </button>
                            )}
                            {item.isCompleted && (
